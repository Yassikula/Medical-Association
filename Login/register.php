...
<!-- 
        ...
        <div class="form-group">
            <label for="user_name" class="col-sm-3 control-label">user_name</label>
            <div class="col-sm-12">
                <input type="text" name="txt_user_name" class="form-control" required placeholder="Enter emuser_nameail">
            </div>
        </div>
